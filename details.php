	...
	<div class="page-container">
		...
		<div class = "results">
			...
			<div id="Kurzinformation" class="tabcontent">
				...
				<div id='checkbox' class='cb3'></div> mittleres Wirkpotential &nbsp;&nbsp;&nbsp; 
				...
				<div class="whiteBox">
					<div class="tableSectionCaption">
						<div style='width:23%'>&nbsp; Anwendungsebene</div>
						<div style='width:20%'>| Flächenbedarf</div>
						<div style='width:26%'>| Nutzungsdauer(Jahre)</div>
						<div style='width:31%'>| Entwicklungsstand</div>
					</div>
